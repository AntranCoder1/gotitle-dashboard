  ...
  implements usersAttributes
{
  ...
  // users belongsTo profiles via profile_id
  profile!: profiles;
  ...
  // users belongsTo user_settings via user_setting_id
  ...
  // users hasMany bought_titles via owner_id
  ...
  // users hasOne connect_accounts via user_id
  connect_account!: connect_accounts;
  getConnect_account!: Sequelize.HasOneGetAssociationMixin<connect_accounts>;
  setConnect_account!: Sequelize.HasOneSetAssociationMixin<
    connect_accounts,
    connect_accountsId
  >;
  // users hasMany invoices via user_id
  invoices!: invoices[];
  ...
  // users hasMany order_items via beneficiary_id
  ...
  // users hasMany orders via customer_id
  orders!: orders[];
  ...
  // users hasMany payment via recipient_id
  payments!: payment[];
  ...
  // users hasMany role_user via user_id
  ...
  removeRole_user!: Sequelize.HasManyRemoveAssociationMixin<
    role_user,
    role_userId
  >;
  removeRole_users!: Sequelize.HasManyRemoveAssociationsMixin<
    role_user,
    role_userId
  >;
  ...
  // users belongsToMany roles via user_id and role_id
  roles!: roles[];
  ...
  // users hasMany search_jobs via claimant_id
  ...
  // users hasMany search_jobs via assigned_user_id
  assigned_user_search_jobs!: search_jobs[];
  getAssigned_user_search_jobs!: Sequelize.HasManyGetAssociationsMixin<search_jobs>;
  setAssigned_user_search_jobs!: Sequelize.HasManySetAssociationsMixin<
    search_jobs,
    search_jobsId
  >;
  addAssigned_user_search_job!: Sequelize.HasManyAddAssociationMixin<
    search_jobs,
    search_jobsId
  >;
  addAssigned_user_search_jobs!: Sequelize.HasManyAddAssociationsMixin<
    search_jobs,
    search_jobsId
  >;
  createAssigned_user_search_job!: Sequelize.HasManyCreateAssociationMixin<search_jobs>;
  removeAssigned_user_search_job!: Sequelize.HasManyRemoveAssociationMixin<
    search_jobs,
    search_jobsId
  >;
  removeAssigned_user_search_jobs!: Sequelize.HasManyRemoveAssociationsMixin<
    search_jobs,
    search_jobsId
  >;
  hasAssigned_user_search_job!: Sequelize.HasManyHasAssociationMixin<
    search_jobs,
    search_jobsId
  >;
  hasAssigned_user_search_jobs!: Sequelize.HasManyHasAssociationsMixin<
    search_jobs,
    search_jobsId
  >;
  countAssigned_user_search_jobs!: Sequelize.HasManyCountAssociationsMixin;
  ...
  // users hasMany title_rating via owner_id
  ...
  // users hasMany title_works via user_created
  ...
  // users hasMany titles via owner_id
  titles!: titles[];
    ...
    users.init(
      ...
      },
      {
        ...
        indexes: [
          ...
          {
            name: "UNIQ_1483A5E9CCFA12B8",
            unique: true,
            using: "BTREE",
            fields: [{ name: "profile_id" }],
          },
          {
            name: "UNIQ_1483A5E949527B9E",
            unique: true,
            using: "BTREE",
